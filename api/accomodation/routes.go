...
func AccomodationRoutes(r *gin.RouterGroup) {
	...
	r.POST("panel/mapQrStudent", mw.Auth, mw.CheckHospitality, mw.CheckGate, MapQrStudentId)
	...
	r.GET("panel/security/:hospitalityId", mw.Auth, mw.CheckHospitality, mw.CheckSecurity, GetStudentDetailsForSecurity)
	r.GET("/panel/hostels", mw.Auth, mw.CheckHospitality, mw.CheckGate, GetAllHostels)
	...
	r.POST("/panel/affirmPayment/:accommodationId", mw.Auth, mw.CheckHospitality, mw.CheckFinance, AffirmAccommodationPayment)
